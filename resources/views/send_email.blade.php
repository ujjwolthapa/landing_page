...
<body> 
        <img src="{{asset('assets/img/logo.jpg')}}" style="width: 15rem  " alt="">
        <h2 class="text-center text-black text-uppercase" id="text1">Malvern Tigers Basketball Club</h2>
        <div id="txt" class="text">
        <h3 class="text-center text-black text-uppercase " id="text">Website</h3>
        <h3 class="text-center text-black text-uppercase " id="text">Comming</h3>
        <h3 class="text-center text-black text-uppercase " id="text">Soon</h3>
        </div>
